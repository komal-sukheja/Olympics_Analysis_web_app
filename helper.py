...
def men_vs_women(df):
    athlete_df = df.drop_duplicates(subset=['Name','region'])
    men = athlete_df[athlete_df['Sex'] == 'M'].groupby(athlete_df['Year']).count()['Name'].reset_index()
    women = athlete_df[athlete_df['Sex'] == 'F'].groupby(athlete_df['Year']).count()['Name'].reset_index()
